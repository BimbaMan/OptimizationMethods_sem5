...
{
    public class OptimizeWithLimit : Data
    {
        readonly int AreaLimit = 1500;
        readonly int Size = 5;
        ...
        public override bool CheckConstraints(Vector<double> vector)
        {
            return CheckPositive(vector) && CheckArea(vector);
        }
        ...
        private bool CheckArea(Vector<double> vector)
        {
            return GetArea(vector) <= AreaLimit;
        }
